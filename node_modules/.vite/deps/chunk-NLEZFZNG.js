import {
  ...
  v,
  vt
} from "./chunk-JWOAZPLS.js";
import {
  Rr
} from "./chunk-KCMXSENB.js";
import {
  A,
  dn,
  x,
...
// node_modules/mermaid/dist/index-d0b453e2.js
var K = 4;
function Q(e) {
  return dn(e, K);
}
...
var nt = (e, t) => {
  ...
  e.nodes().forEach(function(n) {
    ...
    if (S.warn(
      ...
      S.warn("Fixing and trixing link to self - removing XXX", n.v, n.w, n.name), S.warn("Fixing and trixing - removing XXX", n.v, n.w, n.name), s = v2(n.v), a = v2(n.w), e.removeEdge(n.v, n.w, n.name);
      const u = n.w + "---" + n.v;
      e.setNode(u, {
        domId: u,
        id: u,
      ...
      (f[n.v] || f[n.w]) && (S.warn("Fixing and trixing - removing XXX", n.v, n.w, n.name), s = v2(n.v), a = v2(n.w), e.removeEdge(n.v, n.w, n.name), s !== n.v && (r.fromCluster = n.v), a !== n.w && (r.toCluster = n.w), S.warn("Fix Replacing with XXX", s, a, n.name), e.setEdge(s, a, r, n.name));
  }), S.warn("Adjusted Graph", y2(e)), R2(e, 0), S.trace(f);
};
var R2 = (e, t) => {
  ...
  for (const s of n) {
    const a = e.node(s);
    S.warn(" Now next level", s, a), a.clusterNode && R2(a.graph, t + 1);
  }
};
var P = (e, t) => {
  if (t.length === 0)
...
var st = (e, t) => {
  ...
  const n = e.insert("g").attr("class", "cluster" + (t.class ? " " + t.class : "")).attr("id", t.id), r = n.insert("rect", ":first-child"), s = ia(Ut().flowchart.htmlLabels), a = n.insert("g").attr("class", "cluster-label"), u = t.labelType === "markdown" ? Rr(a, t.labelText, { style: t.labelStyle, useHtmlLabels: s }) : a.node().appendChild(R(t.labelText, t.labelStyle, void 0, true));
  let l = u.getBBox();
...
var at = (e, t) => {
  const n = e.insert("g").attr("class", t.classes).attr("id", t.id), r = n.insert("rect", ":first-child"), s = n.insert("g").attr("class", "cluster-label"), a = n.append("rect"), u = s.node().appendChild(R(t.labelText, t.labelStyle, void 0, true));
  let l = u.getBBox();
  if (ia(Ut().flowchart.htmlLabels)) {
    const o = u.children[0], h = At(u);
    l = o.getBoundingClientRect(), h.attr("width", l.width), h.attr("height", l.height);
  ...
  await Promise.all(
    t.nodes().map(async function(c) {
      ...
      if (S.info("(Insert) Node XXX" + c + ": " + JSON.stringify(t.node(c))), o && o.clusterNode) {
        ...
        v(o, C), o.diff = h.diff || 0, S.info("Node bounds (abc123)", c, o, o.width, o.x, o.y), Pt(C, o), S.warn("Recursive render complete ", C, o);
      } else
...
var gt = async (e, t, n, r, s) => {
  Kt(e, n, r, s), tr(), ar(), ft(), tt(), S.warn("Graph at first:", y2(t)), nt(t), S.warn("Graph after:", y2(t)), await k(e, t, r);
};

export {
  gt
};
//# sourceMappingURL=chunk-NLEZFZNG.js.map

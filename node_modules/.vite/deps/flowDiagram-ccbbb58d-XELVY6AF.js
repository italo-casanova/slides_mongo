import {
  ...
  we,
  ye
} from "./chunk-RI2K4AOT.js";
import "./chunk-NLEZFZNG.js";
import {
  Je,
  et
} from "./chunk-LU57RP2A.js";
import "./chunk-JWOAZPLS.js";
import "./chunk-KCMXSENB.js";
import "./chunk-AR3JMUP6.js";
import {
  A,
  b,
  bo,
  ...
  te,
  zs
} from "./chunk-UTQHMTLS.js";
import {
  S
} from "./chunk-G5FOCNDP.js";
...
// node_modules/mermaid/dist/flowDiagram-ccbbb58d.js
function Dt(r) {
  if (!r.ok)
...
function Wt(r, e, t, n) {
  ...
  re(s, t[n + "Style"]), t[n + "Class"] && s.attr("class", t[n + "Class"]);
}
function $t(r, e, t, n) {
...
function K(r, e, t) {
  ...
  e.labelType === "svg" ? zt(a, e) : typeof n != "string" || e.labelType === "html" ? le(a, e) : Yt(a, e);
...
var H = function(r, e) {
  ...
  ye(n.exit(), e).style("opacity", 0).remove();
  ...
  return n = n.merge(a), n = ye(n, e).style("opacity", 1), n.selectAll("rect").each(function(s) {
    var i = e.node(s), o = At(this);
    re(o, i.style);
  }), n;
};
...
var X = function(r, e) {
  ...
  var n;
  return t.exit ? n = t.exit() : n = t.selectAll(null), ye(n, e).style("opacity", 0).remove(), t;
};
function Ft(r) {
  X = r;
}
...
var F = function(r, e, t) {
  ...
  return ye(s, e).style("opacity", 1), s.each(function(i) {
    var o = At(this), c2 = e.edge(i);
    c2.elem = this, c2.id && o.attr("id", c2.id), he(
      o,
      c2.class,
...
var q = function(r, e, t) {
  ...
  var s;
  return a.exit ? s = a.exit() : s = a.selectAll(null), ye(s, e).style("opacity", 0).remove(), a;
};
function jt(r) {
  q = r;
}
function te2(r, e) {
  ...
  t.attr("transform", n), ye(r, e).style("opacity", 1).attr("transform", n), ye(t.selectAll("rect"), e).attr("width", function(a) {
...
function ee(r, e) {
  ...
  t.attr("transform", n), ye(r, e).style("opacity", 1).attr("transform", n);
}
function re2(r, e) {
  var t = r.filter(function() {
    return !At(this).classed("update");
...
function ne(r, e, t, n) {
  var a, s, i, o, c2, d, l, v, h, u, p, g, f, y, k2;
  if (a = e.y - r.y, i = r.x - e.x, c2 = e.x * r.y - r.x * e.y, h = a * t.x + i * t.y + c2, u = a * n.x + i * n.y + c2, !(h !== 0 && u !== 0 && j2(h, u)) && (s = n.y - t.y, o = t.x - n.x, d = n.x * t.y - t.x * n.y, l = s * r.x + o * r.y + d, v = s * e.x + o * e.y + d, !(l !== 0 && v !== 0 && j2(l, v)) && (p = a * o - s * i, p !== 0)))
    return g = Math.abs(p / 2), f = i * d - o * c2, y = f < 0 ? (f - g) / p : (f + g) / p, f = s * c2 - a * d, k2 = f < 0 ? (f - g) / p : (f + g) / p, { x: y, y: k2 };
}
function j2(r, e) {
  return r * e > 0;
}
function T(r, e, t) {
  ...
  return s.length ? (s.length > 1 && s.sort(function(p, g) {
    var f = p.x - t.x, y = p.y - t.y, k2 = Math.sqrt(f * f + y * y), I = g.x - t.x, E = g.y - t.y, U = Math.sqrt(I * I + E * E);
...
function de() {
  ...
  return r.createNodes = function(e) {
    ...
    return arguments.length ? (Ut2(e), r) : Y;
  }, r;
}
var he2 = {
  paddingLeft: 10,
...
var bt = function(r, e, t, n, a, s) {
  ...
  Object.keys(r).forEach(function(d) {
    ...
    if (ia(Ut().flowchart.htmlLabels)) {
      ...
      p = le(i, y).node(), p.parentNode.removeChild(p);
    } else {
...
var xe = function(r, e, t, n) {
  ...
  S2.warn("Get vertices", g);
  const f = n.db.getEdges();
  let y = 0;
  for (y = p.length - 1; y >= 0; y--) {
    u = p[y], j("cluster").append("text");
  ...
  const k2 = new de();
  ge2.addToRender(k2), k2.arrows().none = function(b2, L, m, B) {
  ...
  for (k2(E, h), E.selectAll("g.node").attr("title", function() {
    ...
    if (u = p[y], u.title !== "undefined") {
      ...
      ), L = w[0].x.baseVal.value, m = w[0].y.baseVal.value, B = w[0].width.baseVal.value, C = At(b2[0]).select(".label");
...
//# sourceMappingURL=flowDiagram-ccbbb58d-XELVY6AF.js.map

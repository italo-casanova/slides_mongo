...
// node_modules/mermaid/dist/createText-94e3ebbf.js
function Tt(n, r) {
...
function vt(n, r, t) {
  ...
  function L(d, P, j) {
    ...
    return V;
    function V(E) {
      return d.enter("lineEnding"), d.consume(E), d.exit("lineEnding"), S2;
    }
    function S2(E) {
  ...
  function O(d, P, j) {
    ...
    function S2(A) {
      return A === p ? (d.consume(A), R++, S2) : R < c ? j(A) : (d.exit("codeFencedFenceSequence"), T(d, E, "whitespace")(A));
    }
    function E(A) {
...
function Ae(n, r, t) {
  ...
  function B(o) {
    return o === null || o === 47 || o === 62 || Y(o) ? o !== 47 && l && Yn.includes(i.toLowerCase()) ? (u = 1, e.interrupt ? r(o) : S2(o)) : Fe.includes(i.toLowerCase()) ? (u = 6, o === 47 ? (n.consume(o), D) : e.interrupt ? r(o) : S2(o)) : (u = 7, e.interrupt && !e.parser.lazy[e.now().line] ? t(o) : l ? _(o) : y(o)) : o === 45 || v(o) ? (n.consume(o), i += String.fromCharCode(o), B) : t(o);
  }
  function D(o) {
  ...
  function S2(o) {
    return o === 45 && u === 2 ? (n.consume(o), G) : o === 60 && u === 1 ? (n.consume(o), nn) : o === 62 && u === 4 ? (n.consume(o), H) : o === 63 && u === 3 ? (n.consume(o), U) : o === 93 && u === 5 ? (n.consume(o), W) : C(o) && (u === 6 || u === 7) ? n.check(
      ...
      H,
      E
    )(o) : o === null || C(o) ? E(o) : (n.consume(o), S2);
  }
  function E(o) {
  ...
  function G(o) {
    return o === 45 ? (n.consume(o), U) : S2(o);
  }
  function nn(o) {
    return o === 47 ? (n.consume(o), i = "", J) : S2(o);
  }
  function J(o) {
    return o === 62 && Yn.includes(i.toLowerCase()) ? (n.consume(o), H) : tn(o) && i.length < 8 ? (n.consume(o), i += String.fromCharCode(o), J) : S2(o);
  }
  function W(o) {
    return o === 93 ? (n.consume(o), U) : S2(o);
  }
  function U(o) {
    return o === 62 ? (n.consume(o), H) : o === 45 && u === 2 ? (n.consume(o), U) : S2(o);
  }
  function H(o) {
...
function Te(n, r, t) {
  ...
  function S2(s) {
    return s === 47 ? (n.consume(s), H) : s === 58 || s === 95 || tn(s) ? (n.consume(s), E) : C(s) ? (a = S2, W(s)) : q(s) ? (n.consume(s), S2) : H(s);
  }
  function E(s) {
    return s === 45 || s === 46 || s === 58 || s === 95 || v(s) ? (n.consume(s), E) : A(s);
  }
  function A(s) {
    return s === 61 ? (n.consume(s), Q) : C(s) ? (a = A, W(s)) : q(s) ? (n.consume(s), A) : S2(s);
  }
  function Q(s) {
...
function lr(n, r, t) {
  ...
  function x(S2) {
    return i = Z(i, S2), D(), i[i.length - 1] !== null ? [] : (j(r, 0), p.events = Ln(l, p.events, p), p.events);
  }
  function g(S2, E) {
    return or(f(S2), E);
  }
  ...
  function D() {
    ...
    for (; e._index < i.length; ) {
      const E = i[e._index];
      if (typeof E == "string")
        for (S2 = e._index, e._bufferIndex < 0 && (e._bufferIndex = 0); e._index === S2 && e._bufferIndex < E.length; )
  ...
  function F(S2, E) {
    const A = E || {};
    return A.type = S2, A.start = k(), p.events.push(["enter", A, p]), a.push(A), A;
  }
  function L(S2) {
    const E = a.pop();
  ...
  function j(S2, E) {
    S2.resolveAll && !l.includes(S2) && l.push(S2), S2.resolve && en(
      ...
      E,
      p.events.length - E,
      S2.resolve(p.events.slice(E), p)
    ), S2.resolveTo && (p.events = S2.resolveTo(p.events, p));
  }
  function R() {
    const S2 = k(), E = p.previous, A = p.currentConstruct, Q = p.events.length, G = Array.from(a);
    return {
      restore: nn,
      from: Q
    };
    function nn() {
      e = S2, p.previous = E, p.currentConstruct = A, p.events.length = Q, a = G, V();
    }
  }
  function V() {
...
function Cr(n) {
  ...
  function A(m) {
    ...
    !i("setextHeadingSlurpLineEnding") && r.canContainEols.includes(b.type) && (S2.call(this, m), E.call(this, m));
  }
  function Q() {
    l("atHardBreak", true);
  }
...
//# sourceMappingURL=chunk-KCMXSENB.js.map

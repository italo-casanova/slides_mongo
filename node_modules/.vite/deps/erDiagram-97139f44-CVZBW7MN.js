...
// node_modules/mermaid/dist/erDiagram-97139f44.js
var ct = function() {
...
var de2 = function(t, r, e, n, s) {
  ...
  const p = e.edge(
    ...
    return A2.y;
  }).curve(yf), o = t.insert("path", "#" + n).classed("er relationshipLine", true).attr("d", f(p.points)).style("stroke", R.stroke).style("fill", "none");
...
var ue = function(t, r, e, n) {
  ...
  Yg(o, A2, y, R.useMaxWidth), o.attr("viewBox", `${O.x - g} ${O.y - g} ${y} ${A2}`);
};
...
//# sourceMappingURL=erDiagram-97139f44-CVZBW7MN.js.map

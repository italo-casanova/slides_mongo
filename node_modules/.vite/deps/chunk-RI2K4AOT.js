...
// node_modules/mermaid/dist/styles-3814544c.js
function j(e) {
  return typeof e == "string" ? new mt([document.querySelectorAll(e)], [document.documentElement]) : new mt([ah(e)], ks);
}
var O = (e, l) => I.lang.round(Ot.parse(e)[l]);
var ee = O;
function ue(e, l) {
...
var q = function(e, l, c, a, i, d) {
  ...
  Object.keys(e).forEach(function(f) {
    ...
    if (S.info("vertex", r, r.labelType), r.labelType === "markdown")
      S.info("vertex", r, r.labelType);
...
var oe = async function(e, l, c, a) {
  ...
  let r;
  d === "sandbox" && (r = At("#i" + l));
  const g = d === "sandbox" ? At(r.nodes()[0].contentDocument.body) : At("body"), h = d === "sandbox" ? r.nodes()[0].contentDocument : document, t = new A({
    multigraph: true,
    compound: true
  }).setGraph({
    rankdir: i,
  ...
  if (await gt(S2, t, ["point", "circle", "cross"], "flowchart", l), Oi.insertTitle(T, "flowchartTitleText", w.titleTopMargin, a.db.getDiagramTitle()), Gg(t, T, w.diagramPadding, w.useMaxWidth), a.db.indexNodes("subGraph" + k), !w.htmlLabels) {
...
//# sourceMappingURL=chunk-RI2K4AOT.js.map

...
// node_modules/mermaid/dist/svgDraw-af99a425.js
var S3 = 0;
var O = function(i, e, t, n, r) {
  ...
  const l = e.points, g = S().x(function(d) {
    ...
    return d.y;
  }).curve(yf), s = i.append("path").attr("d", g(l)).attr("id", "edge" + S3).attr("class", "relation");
  let p = "";
  ...
  S2.info("Rendering relation " + JSON.stringify(t)), t.relationTitle1 !== void 0 && t.relationTitle1 !== "none" && i.append("g").attr("class", "cardinality").append("text").attr("class", "type1").attr("x", u).attr("y", m).attr("fill", "black").attr("font-size", "6").text(t.relationTitle1), t.relationTitle2 !== void 0 && t.relationTitle2 !== "none" && i.append("g").attr("class", "cardinality").append("text").attr("class", "type2").attr("x", B).attr("y", T).attr("fill", "black").attr("font-size", "6").text(t.relationTitle2), S3++;
};
...
//# sourceMappingURL=chunk-AR3JMUP6.js.map

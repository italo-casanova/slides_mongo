...
// node_modules/mermaid/dist/c4Diagram-1bdb45a8.js
var qt = function() {
...
function I(e, t, r, o, l2) {
  if (!t[e].width)
    if (r)
      t[e].text = E0(t[e].text, l2, o), t[e].textLines = t[e].text.split(Bn.lineBreakRegex).length, t[e].width = l2, t[e].height = O0(t[e].text, o);
    else {
...
var V0 = function(e, t, r, o) {
  ...
  d && i.append("text").text(d).attr("x", (p.stopx - p.startx) / 2 - 4 * b.diagramMarginX).attr("y", p.starty + b.diagramMarginY), Yg(i, T, S2, b.useMaxWidth);
  const L = d ? 60 : 0;
  i.attr(
    "viewBox",
...
//# sourceMappingURL=c4Diagram-1bdb45a8-SZUGYAYR.js.map

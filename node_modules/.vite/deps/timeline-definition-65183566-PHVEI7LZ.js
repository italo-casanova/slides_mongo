...
// node_modules/mermaid/dist/timeline-definition-65183566.js
var Y = function() {
  var n = function(k, r, a, h) {
    for (a = a || {}, h = k.length; h--; a[k[h]] = r)
      ;
    return a;
  }, t = [1, 2], e = [1, 5], s = [6, 9, 11, 17, 18, 20, 22, 23, 26, 27, 28], i = [1, 15], o = [1, 16], l = [1, 17], p = [1, 18], g = [1, 19], d = [1, 23], f = [1, 24], S2 = [1, 27], _ = [4, 6, 9, 11, 17, 18, 20, 22, 23, 26, 27, 28], b = {
    trace: function() {
    },
    yy: {},
    ...
    table: [{ 3: 1, 4: t, 7: 3, 12: 4, 28: e }, { 1: [3] }, n(s, [2, 3], { 5: 6 }), { 3: 7, 4: t, 7: 3, 12: 4, 28: e }, { 13: 8, 29: [1, 9] }, { 29: [2, 21] }, { 6: [1, 10], 7: 22, 8: 11, 9: [1, 12], 10: 13, 11: [1, 14], 12: 4, 17: i, 18: o, 20: l, 22: p, 23: g, 24: 20, 25: 21, 26: d, 27: f, 28: e }, { 1: [2, 2] }, { 14: 25, 15: [1, 26], 31: S2 }, n([15, 31], [2, 22]), n(s, [2, 8], { 1: [2, 1] }), n(s, [2, 4]), { 7: 22, 10: 28, 12: 4, 17: i, 18: o, 20: l, 22: p, 23: g, 24: 20, 25: 21, 26: d, 27: f, 28: e }, n(s, [2, 6]), n(s, [2, 7]), n(s, [2, 11]), { 19: [1, 29] }, { 21: [1, 30] }, n(s, [2, 14]), n(s, [2, 15]), n(s, [2, 16]), n(s, [2, 17]), n(s, [2, 18]), n(s, [2, 19]), n(s, [2, 20]), { 11: [1, 31] }, { 16: 32, 30: [1, 33] }, { 11: [2, 24] }, n(s, [2, 5]), n(s, [2, 12]), n(s, [2, 13]), n(_, [2, 9]), { 14: 34, 31: S2 }, { 31: [2, 23] }, { 11: [1, 35] }, n(_, [2, 10])],
...
var zt = function(n, t, e) {
  ...
  st++;
  const o = 300 + 5 * 30;
  i.append("line").attr("id", "task" + st).attr("x1", s).attr("y1", t.y).attr("x2", s).attr("y2", o).attr("class", "task-line").attr("stroke-width", "1px").attr("stroke-dasharray", "4 2").attr("stroke", "#666"), At2(i, {
    cx: s,
    cy: 300 + (5 - t.score) * 30,
    score: t.score
  });
...
var mt = function() {
  function n(i, o, l, p, g, d, f, S2) {
    const _ = o.append("text").attr("x", l + g / 2).attr("y", p + d / 2 + 5).style("font-color", S2).style("text-anchor", "middle").text(i);
    s(_, f);
  }
  function t(i, o, l, p, g, d, f, S2, _) {
  ...
  function e(i, o, l, p, g, d, f, S2) {
    ...
    v.append("div").attr("class", "label").style("display", "table-cell").style("text-align", "center").style("vertical-align", "middle").text(i), t(i, _, l, p, g, d, f, S2), s(v, f);
  }
  function s(i, o) {
    for (const l in o)
      l in o && i.attr(l, o[l]);
...
function xt(n, t) {
  n.each(function() {
    var e = At(this), s = e.text().split(/(\s+|<br>)/).reverse(), i, o = [], l = 1.1, p = e.attr("y"), g = parseFloat(e.attr("dy")), d = e.text(null).append("tspan").attr("x", 0).attr("y", p).attr("dy", g + "em");
...
var jt = function(n, t, e, s) {
  ...
  let p;
  l === "sandbox" && (p = At("#i" + t));
  const d = (l === "sandbox" ? At(p.nodes()[0].contentDocument.body) : At("body")).select("#" + t);
  d.append("g");
  const f = s.db.getTasks(), S2 = s.db.getCommonDb().getDiagramTitle();
  ...
  S.debug("maxSectionHeight before draw", b), S.debug("maxTaskHeight before draw", v), _ && _.length > 0 ? _.forEach((C) => {
    ...
    S.debug("sectionNode output", N), m.attr("transform", `translate(${r}, ${k})`), a += b + 50, w.length > 0 && rt(
      d,
      w,
      h,
      r,
  ...
  S.debug("bounds", L), S2 && d.append("text").text(S2).attr("x", L.width / 2 - o).attr("font-size", "4ex").attr("font-weight", "bold").attr("y", 20), I = u ? b + v + 150 : v + 100, d.append("g").attr("class", "lineWrapper").append("line").attr("x1", o).attr("y1", I).attr("x2", L.width + 3 * o).attr("y2", I).attr("stroke-width", 4).attr("stroke", "black").attr("marker-end", "url(#arrowhead)"), Gg(
    void 0,
    d,
...
var rt = function(n, t, e, s, i, o, l, p, g, d, f) {
  ...
  for (const _ of t) {
    ...
    s = s + 200, f && !((S2 = l.timeline) != null && S2.disableMulticolor) && e++;
  }
  i = i - 10;
};
...
//# sourceMappingURL=timeline-definition-65183566-PHVEI7LZ.js.map

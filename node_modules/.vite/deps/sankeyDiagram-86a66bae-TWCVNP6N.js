...
// node_modules/mermaid/dist/sankeyDiagram-86a66bae.js
function At2(t) {
  for (var n = t.length / 6 | 0, i = new Array(n), a = 0; a < n; )
    i[a] = "#" + t.slice(a * 6, ++a * 6);
  return i;
}
var Tt = At2("4e79a7f28e2ce1575976b7b259a14fedc949af7aa1ff9da79c755fbab0ab");
var tt = function() {
...
var It = (t) => (t = Bn.sanitizeText(t, Ut()), D[t] || (D[t] = new Ct(t), Q.push(D[t])), D[t]);
var Ot = () => Q;
var zt = () => q;
var jt = () => ({
...
function Yt() {
  let t = 0, n = 0, i = 1, a = 1, u = 24, k = 8, _, p = Ut2, s = dt, o, c, g = Wt, b = Vt, d = 6;
  function x() {
...
var re = function(t, n, i, a) {
  const { securityLevel: u, sankey: k } = Ut(), _ = ti.sankey;
  let p;
  u === "sandbox" && (p = At("#i" + n));
  const s = u === "sandbox" ? At(p.nodes()[0].contentDocument.body) : At("body"), o = u === "sandbox" ? s.select(`[id="${n}"]`) : At(`[id="${n}"]`), c = (k == null ? void 0 : k.width) || _.width, g = (k == null ? void 0 : k.height) || _.width, b = (k == null ? void 0 : k.useMaxWidth) || _.useMaxWidth, d = (k == null ? void 0 : k.nodeAlignment) || _.nodeAlignment;
  Yg(o, g, c, b);
...
//# sourceMappingURL=sankeyDiagram-86a66bae-TWCVNP6N.js.map

...
// node_modules/mermaid/dist/classDiagram-v2-6dc3b9c3.js
...
var F = function(o, t, p, n) {
  S.info(o), o.forEach(function(e, s) {
    ...
    const l = e, a = "", i = { labelStyle: "", style: "" }, y = l.text, d = 0, f = "note", h = {
      ...
      type: "note",
      // TODO V10: Flowchart ? Keeping flowchart for backwards compatibility. Remove in next major release
      padding: ((m = Ut().flowchart) == null ? void 0 : m.padding) ?? ((x = Ut().class) == null ? void 0 : x.padding)
    };
...
var W = async function(o, t, p, n) {
  ...
  let b;
  s === "sandbox" && (b = At("#i" + t));
  const u = s === "sandbox" ? At(b.nodes()[0].contentDocument.body) : At("body"), m = u.select(`[id="${t}"]`), x = u.select("#" + t + " g");
  if (await gt(
    x,
    i,
...
//# sourceMappingURL=classDiagram-v2-6dc3b9c3-UPBU4SAV.js.map

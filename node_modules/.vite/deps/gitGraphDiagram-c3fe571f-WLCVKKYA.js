...
// node_modules/mermaid/dist/gitGraphDiagram-c3fe571f.js
var pe = function() {
  var r = function(q, m, b, k) {
    ...
    parse: function(m) {
      var b = this, k = [0], i = [], v = [null], e = [], W = this.table, t = "", re = 0, ge = 0, Me = 2, de2 = 1, Ce = e.slice.call(arguments, 1), M = Object.create(this.lexer), Y = { yy: {} };
...
pe.parser = pe;
var Ye = pe;
var ae = Ut().gitGraph.mainBranchName;
var Ke = Ut().gitGraph.mainBranchOrder;
var R = {};
var G = null;
var Z = {};
...
var We = function(r) {
  ...
  try {
    ...
    S.error("error while parsing gitGraph options", a.message);
  }
};
var Xe = function() {
  return Ee;
...
var Qe = function(r, a, o, p) {
  S.debug("Entering commit:", r, a, o, p), a = Bn.sanitizeText(a, Ut()), r = Bn.sanitizeText(r, Ut()), p = Bn.sanitizeText(p, Ut());
  const n = {
    id: a || U + "-" + be(),
    message: r,
    seq: U++,
  ...
  G = n, R[n.id] = n, L[A] = n.id, S.debug("in pushCommit " + n.id);
};
var Ze = function(r, a) {
  if (r = Bn.sanitizeText(r, Ut()), L[r] === void 0)
    L[r] = G != null ? G.id : null, Z[r] = { name: r, order: a ? parseInt(a, 10) : null }, we(r), S.debug("in createBranch");
  else {
    let o = new Error(
...
var $e = function(r, a, o, p) {
  ...
  G = u, R[u.id] = u, L[A] = u.id, S.debug(L), S.debug("in mergeBranch");
};
var et = function(r, a, o) {
  if (S.debug("Entering cherryPick:", r, a, o), r = Bn.sanitizeText(r, Ut()), a = Bn.sanitizeText(a, Ut()), o = Bn.sanitizeText(o, Ut()), !r || R[r] === void 0) {
    let c = new Error(
  ...
  if (!a || R[a] === void 0) {
    ...
    G = u, R[u.id] = u, L[A] = u.id, S.debug(L), S.debug("in cherryPick");
  }
};
var we = function(r) {
  if (r = Bn.sanitizeText(r, Ut()), L[r] === void 0) {
...
function Te(r) {
  ...
  for (let n in L)
    L[n] === a.id && p.push(n);
  if (S.debug(p.join(" ")), a.parents && a.parents.length == 2) {
...
var rt = function() {
  R = {}, G = null;
  let r = Ut().gitGraph.mainBranchName, a = Ut().gitGraph.mainBranchOrder;
  L = {}, L[r] = null, Z = {}, Z[r] = { name: r, order: a }, A = r, U = 0, Fa();
};
var it = function() {
...
var _e = (r, a, o) => {
  const p = Da().gitGraph, n = r.append("g").attr("class", "commit-bullets"), c = r.append("g").attr("class", "commit-labels");
  let u = 0;
  S2 === "TB" && (u = 30), Object.keys(a).sort((x, l) => a[x].seq - a[l].seq).forEach((x) => {
    const l = a[x], g = S2 === "TB" ? u + 10 : C[l.branch].pos, f = S2 === "TB" ? C[l.branch].pos : u + 10;
    if (o) {
    ...
    if (S2 === "TB" ? ee[l.id] = { x: f, y: u + 10 } : ee[l.id] = { x: u + 10, y: g }, o) {
      if (l.type !== B.CHERRY_PICK && (l.customId && l.type === B.MERGE || l.type !== B.MERGE) && p.showCommitLabel) {
        ...
        if (O.attr("x", u + 10 - d.width / 2 - 2).attr("y", g + 13.5).attr("width", d.width + 2 * 2).attr("height", d.height + 2 * 2), S2 === "TB" && (O.attr("x", f - (d.width + 4 * 4 + 5)).attr("y", g - 12), E.attr("x", f - (d.width + 4 * 4)).attr("y", g + d.height - 12)), S2 !== "TB" && E.attr("x", u + 10 - d.width / 2), p.rotateCommitLabel)
          if (S2 === "TB")
      ...
      if (l.tag) {
        ...
        T.attr("class", "tag-label-bkg").attr(
          ...
          ${u + 10 + d.width / 2 + 4},${N + y + 2}
          ${u + 10 - d.width / 2 - 4},${N + y + 2}`
        ), O.attr("cx", u - d.width / 2 + 4 / 2).attr("cy", N).attr("r", 1.5).attr("class", "tag-hole"), S2 === "TB" && (T.attr("class", "tag-label-bkg").attr(
          "points",
          `
            ${f},${u + 2}
            ${f},${u - 2}
...
var ft = (r, a) => {
  const o = Da().gitGraph, p = r.append("g");
  a.forEach((n, c) => {
    const u = c % F, h = C[n.name].pos, w = p.append("line");
    w.attr("x1", 0), w.attr("y1", h), w.attr("x2", te), w.attr("y2", h), w.attr("class", "branch branch" + u), S2 === "TB" && (w.attr("y1", 30), w.attr("x1", h), w.attr("y2", te), w.attr("x2", h)), ne.push(h);
    let x = n.name;
    ...
    ), S2 === "TB" && (g.attr("x", h - _.width / 2 - 10).attr("y", 0), s.attr("transform", "translate(" + (h - _.width / 2 - 5) + ", 0)")), S2 !== "TB" && g.attr("transform", "translate(-19, " + (h - _.height / 2) + ")");
  });
};
var bt = function(r, a, o, p) {
  ht();
  const n = Da(), c = n.gitGraph;
  S.debug("in gitgraph renderer", r + `
`, "id:", a, o), X = p.db.getCommits();
  const u = p.db.getBranchesAsObjArray();
  S2 = p.db.getDirection();
  const h = At(`[id="${a}"]`);
  let w = 0;
  u.forEach((x, l) => {
    ...
    let T = g.getBBox();
    C[x.name] = { pos: w, index: l }, w += 50 + (c.rotateCommitLabel ? 40 : 0) + (S2 === "TB" ? T.width / 2 : 0), _.remove(), s.remove(), f.remove();
...
//# sourceMappingURL=gitGraphDiagram-c3fe571f-WLCVKKYA.js.map

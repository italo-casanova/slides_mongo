...
var _chunkI433I4X2js = require('./chunk-I433I4X2.js');
...
async function load(filepath, themeMeta, content) {
  ...
  const data = await _chunkI433I4X2js.parse.call(void 0, markdown, filepath, themeMeta, [], async (headmatter, exts, filepath2) => {
  ...
  for (let iSlide = 0; iSlide < data.slides.length; ) {
    ...
    const subSlides = await _chunkI433I4X2js.parse.call(void 0, raw, path, themeMeta, preparserExtensions);
    for (const [offset, subSlide] of subSlides.slides.entries()) {
      ...
      data.features = _chunkI433I4X2js.mergeFeatureFlags.call(void 0, data.features, _chunkI433I4X2js.detectFeatures.call(void 0, raw));
      entries.add(path);
...
async function save(data, filepath) {
  ...
  await _fs.promises.writeFile(filepath, _chunkI433I4X2js.stringify.call(void 0, data), "utf-8");
}
async function saveExternalSlide(slide) {
  await _fs.promises.writeFile(slide.filepath, _chunkI433I4X2js.stringifySlide.call(void 0, slide), "utf-8");
}
...
exports.detectFeatures = _chunkI433I4X2js.detectFeatures; exports.filterDisabled = _chunkI433I4X2js.filterDisabled; exports.getDefaultConfig = _chunkI433I4X2js.getDefaultConfig; exports.injectPreparserExtensionLoader = injectPreparserExtensionLoader; exports.load = load; exports.mergeFeatureFlags = _chunkI433I4X2js.mergeFeatureFlags; exports.parse = _chunkI433I4X2js.parse; exports.parseAspectRatio = _chunkI433I4X2js.parseAspectRatio; exports.parseRangeString = _chunkI433I4X2js.parseRangeString; exports.parseSlide = _chunkI433I4X2js.parseSlide; exports.prettify = _chunkI433I4X2js.prettify; exports.prettifySlide = _chunkI433I4X2js.prettifySlide; exports.resolveConfig = _chunkI433I4X2js.resolveConfig; exports.resolveFonts = _chunkI433I4X2js.resolveFonts; exports.save = save; exports.saveExternalSlide = saveExternalSlide; exports.scanMonacoModules = _chunkI433I4X2js.scanMonacoModules; exports.stringify = _chunkI433I4X2js.stringify; exports.stringifySlide = _chunkI433I4X2js.stringifySlide; exports.verifyConfig = _chunkI433I4X2js.verifyConfig;
